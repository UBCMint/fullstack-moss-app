    ...
    return (
        ...
        >
            <div className="flex items-start gap-4 p-5">
                <div
                    className={['mt-0.5 h-6 w-6 shrink-0', iconColor].join(' ')}
                >
                    {item.type === 'success' ? (
                ...
                <div className="flex min-w-0 flex-1 flex-col">
                    ...
                    {item.description ? (
                        <p
                            className={['mt-1 text-sm leading-5', text].join(
                                ' '
                            )}
                        >
                            {item.description}
...
export function NotificationsShowcase() {
    ...
    const triggerError = () =>
        error({
            ...
            description:
                'Could not load contents of [file-path]. Please load a different file.',
